  ...
  return (
    <div className="grid gap-6 md:grid-cols-2">
      <div className="space-y-4">
        ...
        <Button onClick={()=>{}} className="bg-[#09ffec] text-[#0D0C34] hover:bg-[#09ffec]/90">Calculate</Button>
      </div>
      <div className="space-y-4">
            ...
            <div className="h-60">
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={chartData} margin={{ left: 6, right: 12, top: 10, bottom: 0 }}>
                  ...
                  <Legend />
                  <Area type="monotone" dataKey="invested" name="Invested" stroke="#09ffec" fill="url(#sipA)" />
                  <Area type="monotone" dataKey="value" name="Value" stroke="#8b5cf6" fill="url(#sipB)" />
                </AreaChart>
              </ResponsiveContainer>
            </div>
          </CardContent>
