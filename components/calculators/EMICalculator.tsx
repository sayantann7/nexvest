...
import { calculateEmi, buildEmiAmortization } from "@/features/calculators/logic/emi";
        ...
        <Card className="bg-[#131740] border-white/10 text-white">
          <CardContent className="p-6 space-y-2">
            <div className="flex items-center justify-between">
              ...
              <span className="font-semibold">{currency(result.emi)}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-slate-300">Total Interest</span>
              <span className="text-rose-300">{currency(result.totalInterest)}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-slate-300">Total Payment</span>
              <span>{currency(result.totalPayment)}</span>
            </div>
          </CardContent>
        </Card>
        <Card className="bg-[#131740] border-white/10 text-white">
