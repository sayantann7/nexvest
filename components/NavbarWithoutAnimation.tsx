...
function NavbarWithoutAnimation() {
    ...
    return (
    <nav className="sticky top-0 z-30 bg-[#0D0C34]/80 backdrop-blur supports-[backdrop-filter]:bg-[#0D0C34]/70 border-b border-white/10 text-white">
            ...
            {!isMobileView && (
                <button className="hidden lg:flex items-center space-x-2 bg-white/10 px-4 py-2 rounded-full">
                    <Image
