...
export namespace Prisma {
  ...
  */
  ...
  export type QueryOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "fullName" | "phoneNumber" | "query", ExtArgs["result"]["query"]>
  ...
  interface QueryFieldRefs {
    ...
    readonly phoneNumber: FieldRef<"Query", 'String'>
  ...
  export type QueryWhereInput = {
    ...
    phoneNumber?: StringFilter<"Query"> | string
  ...
  export type QueryScalarWhereWithAggregatesInput = {
    ...
    phoneNumber?: StringWithAggregatesFilter<"Query"> | string
